...
**Configuration under test:** current implementation (hybrid RRF + cross-encoder rerank `ms-marco-MiniLM-L-6-v2`). Dataset: `shieldcare_full` — corpus: `shieldcare_full.pdf` (22 chunks), k=3.
